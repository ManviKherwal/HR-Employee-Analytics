...
| `HR_EMPLOYEE_ANALYTICS.sql` | SQL Queries |
| `HR_EMPLOYEE_ANALYSIS.pbix` | Power BI Dashboard |
| `IBM_HR_Analytics_Cleaned.csv` | Cleaned Dataset |
...
- **Page 4** — Performance & Key Insights
...
- Avg monthly income is ₹6.50K
- Life Sciences background is most common (41.22%)
